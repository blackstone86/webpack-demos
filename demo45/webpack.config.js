...
const webpackConfig = {
  ...
  resolve: {
    ...
    // 可以省略 mainFields，如果要写，当使用了 antd 注意加上 'module' ，因为 es 模块 mainFields 为 module，如果没加导致 chunk 大好多倍体积！
...
module.exports = function (env = {}, argv) {
  const withAnalyse = !!env['analyse'];

  if (withAnalyse) {
    const BundleAnalyzerPlugin = require('webpack-bundle-analyzer').BundleAnalyzerPlugin;
    webpackConfig.plugins.push(new BundleAnalyzerPlugin());
    webpackConfig.stats = {
      // 为 scope hoisting 优化功能开启日志说明，如 ModuleConcatenation bailout: Module is not an ECMAScript module
